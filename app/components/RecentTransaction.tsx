...
export default function RecentTransaction() {
  return (
    <section className="w-[350px] h-[282px]  rounded-[18px] whitespace-nowrap p-5 flex flex-col gap-[20px] ">
      <h2 className="font-semibold text-[22px] leading-[27px] text-[#343C6A] mb-2">
        Recent Transaction
      </h2>
      <div className="bg-white rounded-[25px] w-full h-[282px] flex flex-col py-4">
        {/* Transaction 1 */}
